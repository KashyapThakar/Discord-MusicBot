	...
	run: async function (client, message, args) {
		...
		if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
			...
			try {
				...
				let thing = new MessageEmbed()
					.setAuthor("Playlist has been added to queue", "https://raw.githubusercontent.com/KashyapThakar/Discord-MusicBot/master/assets/Music.gif")
		...
		async function handleVideo(video, message, channel, playlist = false) {
			...
			if (!serverQueue) {
				...
				if (playlist) return;
				let thing = new MessageEmbed()
					.setAuthor("Song has been added to queue", "https://raw.githubusercontent.com/KashyapThakar/Discord-MusicBot/master/assets/Music.gif")
...
let thing = new MessageEmbed()
				.setAuthor("Started Playing Music!", "https://raw.githubusercontent.com/KashyapThakar/Discord-MusicBot/master/assets/Music.gif")
				.setThumbnail(song.img)
				.setColor("BLUE")
				.addField("Name", song.title, true)
				.addField("Duration", song.duration, true)
